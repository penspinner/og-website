...
<?php $title = "Steven Liao Projects"; $active_page = "Home"; 
			$stylesheets = array("/css/MainStyle.css", "/css/ProjectsStyle.css");
			$extscripts = array("/js/ProjectsPage.js"); ?>
<?php require_once("../includes/functions.php"); ?>
<?php include("../includes/layouts/header.php"); ?>

	<header>
			<h1><!-- <canvas id="canvas" style="width:126px; height:50px;"></canvas> --><a href="/">Steven Liao</a></h1>
			<?php echo navigation("projects"); ?>
	</header>
